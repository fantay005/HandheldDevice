...
#define GSM_GPRS_HEART_BEAT_TIME     (configTICK_RATE_HZ * 60 * 3)
#define METE_GPRS_HEART_BEAT_TIME	 (configTICK_RATE_HZ * 60 * 5)
...
bool __gsmInitRuntime() {
	...
	if (bauds[i] != 19200) {
		...
		printf("Baudrate changed to 19200\n");
