...
#define SMS3_PARAM_STORE_ADDR (0x400000 - 7*4*1024)
#define SMS4_PARAM_STORE_ADDR (0x400000 - 8*4*1024)
#define SMS5_PARAM_STORE_ADDR (0x400000 - 9*4*1024)
#define SMS6_PARAM_STORE_ADDR (0x400000 - 10*4*1024)
#define SMS7_PARAM_STORE_ADDR (0x400000 - 11*4*1024)
#define SMS8_PARAM_STORE_ADDR (0x400000 - 12*4*1024)
#define SMS9_PARAM_STORE_ADDR (0x400000 - 13*4*1024)
#define SMS10_PARAM_STORE_ADDR (0x400000 - 14*4*1024)
