...
uint8_t one[32] = { 0x87,0xC0,0x58,0x30,0x20,0x08,0x51,0x04,0x4B,0x04,0x85,0x02,0x83,0x02,0x81,0x02,
	                	0x81,0x82,0x81,0x42,0x41,0x24,0x41,0x14,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				  };  //① 16*16字库

uint8_t two[32] = { 0x87,0xC0,0x58,0x30,0x20,0x08,0x53,0x84,0x4C,0x44,0x84,0x42,0x82,0x42,0x81,0x82,
		                0x81,0x82,0x82,0x42,0x44,0x24,0x47,0xD4,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ② 16*16字库

uint8_t three[32] = { 0x87,0xC0,0x58,0x30,0x20,0x08,0x57,0xC4,0x48,0x44,0x84,0x82,0x83,0x02,0x83,0x02,
		                  0x80,0x82,0x80,0x42,0x44,0x64,0x43,0x94,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ③ 16*16字库

uint8_t four[32] = { 0x87,0xC0,0x58,0x30,0x20,0x08,0x51,0x04,0x4A,0x04,0x86,0x02,0x86,0x82,0x85,0x82,
	                 	 0x88,0x82,0x8F,0xE2,0x40,0xA4,0x40,0x94,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ④ 16*16字库

uint8_t five[32] = { 0x87,0xC0,0x58,0x30,0x20,0x08,0x57,0xC4,0x4C,0x04,0x84,0x02,0x87,0x82,0x81,0x42,
		                 0x80,0xC2,0x80,0x42,0x48,0xA4,0x47,0x14,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ⑤ 16*16字库

uint8_t six[32] = {0x87,0xC0,0x58,0x30,0x20,0x08,0x51,0x04,0x4A,0x04,0x86,0x02,0x86,0x02,0x85,0x82,
		               0x86,0xC2,0x84,0x42,0x44,0x64,0x43,0x94,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ⑥ 16*16字库

uint8_t seven[32] = { 0x87,0xC0,0x58,0x30,0x20,0x08,0x57,0xC4,0x48,0x44,0x84,0x82,0x82,0x82,0x81,0x02,
		                  0x81,0x82,0x81,0x42,0x41,0x24,0x41,0x14,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ⑦ 16*16字库

uint8_t eight[32] = {0x87,0xC0,0x58,0x30,0x20,0x08,0x53,0x84,0x4C,0x44,0x84,0x42,0x86,0x42,0x83,0x82,
	                   0x84,0xC2,0x84,0x42,0x44,0x64,0x43,0x94,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ⑧ 16*16字库

uint8_t nine[32] = { 0x87,0xC0,0x58,0x30,0x20,0x08,0x53,0x84,0x4C,0x44,0x84,0x42,0x86,0x42,0x83,0xC2,
		                 0x80,0xC2,0x80,0xC2,0x41,0x24,0x42,0x14,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ⑨ 16*16字库

uint8_t ten[32] = { 0x87,0xC0,0x58,0x30,0x20,0x08,0x59,0xC4,0x5A,0x24,0xAE,0x22,0x8A,0x22,0x8B,0x22,
		                0x8A,0xA2,0x8A,0x62,0x4A,0x24,0x49,0xD4,0x20,0x08,0x18,0x34,0x07,0xC2,0x00,0x01,
				   };  // ⑩ 16*16字库
