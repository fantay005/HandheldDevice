...
#define SMS3_PARAM_STORE_ADDR (0x400000 - 6*4*1024)
#define SMS4_PARAM_STORE_ADDR (0x400000 - 7*4*1024)
#define SMS5_PARAM_STORE_ADDR (0x400000 - 8*4*1024)
#define SMS6_PARAM_STORE_ADDR (0x400000 - 9*4*1024)
#define SMS7_PARAM_STORE_ADDR (0x400000 - 10*4*1024)
